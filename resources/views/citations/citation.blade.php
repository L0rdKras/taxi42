...
<div class="container theme-showcase" style="padding-top:80px" role="main">
	<h2>Registro de Citaciones</h2>
    <div class="page-hader">
        <div class="panel panel-default">

  			<div class="panel-heading">Datos</div>
  			<div class="panel-body">
	        	{!! Form::open(array('id'=>'formCitation','route' => ['save-citation'],'method'=>'POST')) !!}
	        		<div class="row">
	        			<h4>
		        		      {!! Form::label('date', 'Fecha',array('class' => 'label label-default col-md-2')); !!}
					            {!! Form::text('date',null,array('id'=>'date','class'=>'col-md-2 campoIngreso')); !!}
					    </h4>
				    </div>
	        		<div class="row">
	        			<h4>
		        		      {!! Form::label('commit', 'Comentario',array('class' => 'label label-default col-md-2')); !!}
					            {!! Form::textarea('commit',null,array('size'=>'30x5','id'=>'commit','class'=>'col-md-2 campoIngreso')); !!}
					    </h4>
				    </div>

				    <div class="row">
	        			<h4>
		        	{!! Form::label('person', 'Persona',array('class' => 'label label-default col-md-2')); !!}
...
<script src="{{ asset('js/registerCitation.js')}}"></script>
